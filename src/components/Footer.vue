<template>
    ...
    <footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
      <div class="flex flex-col md:flex-row">
        ...
        <div class="w-full lg:w-2/4 mt-8 lg:mt-0 lg:mx-4 lg:pr-8">
          ...
          <ul class="mt-4">
            <li>
              <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span class="ml-3">
                  8 Belmont  Street, Garlington Estate, Hilton, KZN, 3245
                </span>
              </a>
            </li>
            <li class="mt-4">
            ...
            <li class="mt-4">
              <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span class="ml-3">
                  <a href="tel:083 656 1804"><strong>Sales enquiries:</strong> 083 656 1804</a>
                </span>
              </a>
            </li>
            <li class="mt-4">
              <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span class="ml-3">
                  <a href="tel:082 560 6631"><strong>Residential Projects:</strong> 082 560 6631</a>
                </span>
              </a>
            </li>
            <li class="mt-4">
              <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span class="ml-3">
                  <a href="tel:083 257 7773"><strong>Engineering:</strong> 083 257 7773</a>
                </span>
              </a>
            </li>
            <li class="mt-4">
      ...
      <div data-netlify-identity-button class="text-sm text-gray-400 lg:mt-2 lg:mx-4">
        <a href="/admin" title="" class="opacity-75 hover:opacity-100">Login</a>
      </div>
    </footer>
